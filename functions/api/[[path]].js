...
const TABLES = {
  ...
  materials:        { table: 'materials',         pk: 'id', cols: ['id','name','type_id','series_id','rate','cost','bar_len','stock','min_stock','unit','supplier'], prefix: 'm' },
...
function validateWrite(resource, body) {
  ...
  if (resource === 'deal_items') {
    ...
    for (const f of ['rate', 'cost', 'bar_len', 'stock', 'min_stock']) {
      const v = n(body[f]);
